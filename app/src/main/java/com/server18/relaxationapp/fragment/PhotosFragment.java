...
public class PhotosFragment extends Fragment {
  private  ProgressDialog pd;
    ...
    private ArrayList<String> arrayList_photosdatas = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showProgressDialog();
        registerUserPost("");
        listView =(ListView)v.findViewById(R.id.listview_photos);
        arrayAdapter = new ArrayAdapter(getActivity(),android.R.layout.simple_list_item_1,arrayList_photosdatas);
                     ...
                     //   Toast.makeText(getActivity(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            for(int i = 0; i<jsonArray.length();i++){
                                ...
                                count++;
                                arrayList_photosdatas.add(category_name);
                                if(count == 7){
                                    break;
                                }
