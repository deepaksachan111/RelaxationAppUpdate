...
public class WordsFragment extends Fragment {
    ...
    private ArrayList<String> arrayList_wordsdatas = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showProgressDialog();
        registerUserPost("");
        listView =(ListView)v.findViewById(R.id.listview_words);
        arrayAdapter = new ArrayAdapter(getActivity(),android.R.layout.simple_list_item_1,arrayList_wordsdatas);
                     ...
                     //   Toast.makeText(getActivity(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            for(int i = 0; i<jsonArray.length();i++){
                                ...
                                count++;
                                arrayList_wordsdatas.add(category_name);
                                if(count == 7){
                                    break;
                                }
